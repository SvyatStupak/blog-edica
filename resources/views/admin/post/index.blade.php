                                    ...
                                    <tbody>
                                        @foreach ($posts as $post)
                                            <tr>
                                                <td>{{ $post->id }}</td>
                                                <td>{{ $post->title }}</td>
                                                <td><a href="{{ route('admin.post.show', $post->id) }}"><i class="nav-icon fas fa-solid fa-eye"></i></a></td>
                                                <td><a href="{{ route('admin.post.edit', $post->id) }}"><i class="nav-icon fas text-success fa-pen-fancy"></i></a></td>
                                                <td>
